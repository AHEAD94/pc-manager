...
public class ErrorOpen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_error_open);
        ...
        TextInputEditText_diagonal = findViewById(R.id.editText3);
        ...
        TextInputEditText_diagonal.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (Math.abs(dia - diagonal) > 6) { // 대각선검사
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button1:
                ...
                if (Math.abs(dia - diagonal) > 6) { // 깊이검사
                    diaErr = "부적합";
                ...
                Toast.makeText(getApplicationContext(), "길이 : "+lenErr+" ,  폭 : "+widErr+" ,  대각선 : "+ diaErr, Toast.LENGTH_LONG).show();

                if (lenErr == "적합" && widErr == "적합" && diaErr == "적합") {

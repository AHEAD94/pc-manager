...
public class ErrorSlab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_error_slab);
        ...
        TextInputEditText_length.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (Math.abs(len - length) > 19) { // 길이검사
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.buttonRepair:
                ...
                // 사진
                databaseReference.child("repairing").child("mID"+position).child("photo").child("item").setValue("미등록");
                // 보고서

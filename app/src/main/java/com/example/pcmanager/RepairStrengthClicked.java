...
public class RepairStrengthClicked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repair_strength_clicked);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button15:
                ...
                databaseReference.child("modules").child("mID"+position).child("test").child("strength").setValue("재검사 요청됨");
                databaseReference.child("repairing").child("strength").child("mID"+position).removeValue();
                ...
                databaseReference.child("requested").child("strength").child("mID"+position).child("test").child("strength").setValue("재검사");

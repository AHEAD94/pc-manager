...
public class RepairConcreteClicked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repair_concrete_clicked);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button15:
                ...
                databaseReference.child("modules").child("mID"+position).child("test").child("concrete").setValue("재검사 요청됨");
                databaseReference.child("repairing").child("concrete").child("mID"+position).removeValue();
                ...
                databaseReference.child("requested").child("concrete").child("mID"+position).child("test").child("concrete").setValue("재검사");

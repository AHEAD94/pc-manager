...
public class ErrorStair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_error_stair);
        ...
        TextInputEditText_length.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                lock[0] = 1;
                int unlock = 0;
                for (int i = 0; i < 2; i++) unlock += lock[i];
                if (unlock == 2) button1.setEnabled(true);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button1:
                ...
                Toast.makeText(getApplicationContext(), "길이 : "+lenErr+" ,  폭 : "+widErr, Toast.LENGTH_LONG).show();

                if (lenErr == "적합" && widErr == "적합") {

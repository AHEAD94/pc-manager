...
public class RepairCoveringClicked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repair_covering_clicked);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button15:
                ...
                databaseReference.child("modules").child("mID"+position).child("test").child("covering").setValue("재검사 요청됨");
                databaseReference.child("repairing").child("covering").child("mID"+position).removeValue();
                ...
                databaseReference.child("requested").child("covering").child("mID"+position).child("test").child("covering").setValue("재검사");

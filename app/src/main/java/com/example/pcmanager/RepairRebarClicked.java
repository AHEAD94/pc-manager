...
public class RepairRebarClicked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repair_rebar_clicked);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button15:
                ...
                databaseReference.child("modules").child("mID"+position).child("test").child("rebar").setValue("재검사 요청됨");
                databaseReference.child("repairing").child("rebar").child("mID"+position).removeValue();
                ...
                databaseReference.child("requested").child("rebar").child("mID"+position).child("test").child("rebar").setValue("재검사");
